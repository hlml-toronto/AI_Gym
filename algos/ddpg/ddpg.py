...
def ddpg(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0,
         ...
         max_ep_len=1000, logger_kwargs=dict(), save_freq=1, render_freq=None):
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument('--env', type=str, default='BipedalWalker-v3')  # does not work with 'LunarLander-v2'
